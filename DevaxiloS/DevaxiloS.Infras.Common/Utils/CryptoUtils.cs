...
namespace DevaxiloS.Infras.Common.Utils
{
    ...
    {
        private const string Key = "1a12e0fe1109e54f4ce052988cb4eb47";
        ...
        public static string EncryptInfo(string toEncrypt, string infoObject, bool useHashing = true)
        {
            byte[] keyArray;
            byte[] toEncryptArray = Encoding.UTF8.GetBytes(toEncrypt);
        ...
        public static string DecryptInfo(string cipherString, string infoObject, bool useHashing = true)
        {
            byte[] keyArray;
            //get the byte code of the string
